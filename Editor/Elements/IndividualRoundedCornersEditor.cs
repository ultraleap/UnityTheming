...
{
    [CustomEditor(typeof(IndividualRoundedCorners))]
    public class IndividualRoundedCornersEditor : Editor
    {
        public override void OnInspectorGUI()
        {
            ...
            {
                IndividualRoundedCorners corners = (IndividualRoundedCorners)serializedObject.targetObject;
